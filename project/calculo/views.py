...
from project.calculo.models import Tbextrato, Tbcalculotitulo, TbtrMensal
from project.core.models import Tbmunicipio, AuthUser
...
def calculo_tr():
    #aguardando retorno do economista para calculos mensais TR
    return 3.7999
