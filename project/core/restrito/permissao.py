...
response_consulta  = "/core/permissao/consulta/"
...
#gravando na sessao o resultado da consulta preparando para o relatorio/pdf
    ...
    return render_to_response('core/permissao/consulta.html' ,{'lista':lista}, context_instance = RequestContext(request))
...
def cadastro(request):
    ...
    return render_to_response('core/permissao/cadastro.html',{"content":content}, context_instance = RequestContext(request))
...
def edicao(request, id):
    ...
    if request.method == "POST":
        ...
        return HttpResponseRedirect("/core/permissao/consulta/")
    
    return render_to_response('core/permissao/edicao.html', {"permissao":instance,"content":content}, context_instance = RequestContext(request))
